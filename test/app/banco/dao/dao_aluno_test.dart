...
main() async{
  ...
  test('dao aluno - teste inserir', () async {
    var dto = DAOAluno(nome: 'PAULO', descricao: 'BIOLOGIA',cpf: '589.156.920-55', urlAvatar: 'https://cdn.pixabay.com/photo/2013/07/13/10/07/man-156584_1280.png', status: 'A');
  ...
  test('dao professor - teste alterar', () async {
    var dto = DAOAluno(nome: 'PAULO', descricao: 'BIOLOGIA',cpf: '589.156.920-55', urlAvatar: 'https://cdn.pixabay.com/photo/2013/07/13/10/07/man-156584_1280.png', status: 'A');
    dto = await dao.salvar(dto);
    var dtoAlterado = DAOAluno(nome: 'PAULO', descricao: 'GEOGRAFIA',cpf: '589.156.920-55', urlAvatar: 'https://cdn.pixabay.com/photo/2013/07/13/10/07/man-156584_1280.png', status: 'A');
